...
class EmbedTwitterTest {
    ...
    fun write() {
        ...
        assertEquals("<div class='tweet' data-id='1264718256809656320' data-width='600' data-height='320' data-caption='Yo'></div>\n", writer.toString())
    }
    ...
    fun read() {
        ...
        assertEquals("https://twitframe.com/show?url=https://twitter.com/wutsi2/status/1264718256809656320", block?.data?.embed)
        assertEquals("https://twitter.com/wutsi2/status/1264718256809656320", block?.data?.source)
    }

    private fun createBlock(id: String, caption: String) = Block(
